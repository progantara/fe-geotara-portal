		...
		<footer className="p-4 text-white bg-green-600 pt-12 sm:px-20 md:px-14">
			...
			<div className="md:flex md:justify-between">
				...
				<div className='mb-5 md:w-1/3 md:pt-4 md:ml-5'>
					...
					<ul>
						...
						<li className="mb-2">
							<a href="../../Pages/Artikel/index.jsx" className="hover:underline">
								Artikel
							</a>
						</li>
						<li className="mb-2">
			...
			<div className="sm:flex sm:items-center sm:justify-between">
				...
				<div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 justify-center">
					<a href="https://www.instagram.com/geotaraofficial/" className=" dark:hover:text-white">
					...
					<a href="https://github.com/progantara" className=" dark:hover:text-white">
						<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
							<path
								fillRule="evenodd"
