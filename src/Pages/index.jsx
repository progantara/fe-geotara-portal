...
const Hero = () => {
	return (
		<section className="bg-center bg-cover bg-pattern">
			<div className="flex justify-between p-5 md:p-0 md:pt-8 xl:px-20">
				{/* Hero */}
				<div className="flex flex-col text-center text-primary md:px-14 md:text-left md:flex-row md:flex-wrap md:items-center md:py-14 xl:justify-between">
					{/* Image Hero */}
					...
					<div className="order-2 md:order-1 md:basis-1/2">
						...
						<p className="mt-2 mb-5 text-sm md:mt-5 xl:text-lg">
							Isilah hari-hari libur kamu dengan sesuatu <span className="hidden md:block"></span> yang membuat
							kamu tersenyum, tertawa, dan bersyukur.
						</p>
						{/* Button */}
							...
							<Button size="small" width="content">
								<Link to="/virtual-tour">
									<div className="md:flex md:items-center">
										<span className="mr-3 xl:text-base">
											Mulai Sekarang
										</span>
										<FiArrowRight />
									</div>
					...
					<div className="order-3 md:order-4 md:mt-10">
						<div className="flex flex-row justify-between mb-5 md:gap-10">
							{/* Item 1 */}
						...
						<Button size="small" width="full">
							<Link to="/virtual-tour">
								<div className="flex items-center justify-center">
									<span className="flex mr-3">Mulai Sekarang</span>
									<FiArrowRight />
								</div>
							</Link>
						</Button>
...
const TopWisata = () => {
	...
	return (
		<section className="mb-5 bg-center bg-cover bg-pattern">
			<div className="flex flex-col justify-between p-5 md:p-0 md:pt-8 md:px-14 lg:px-16 xl:px-32">
				...
				<div className="flex flex-col">
					...
					<h1 className="mb-8 font-extrabold text-md text-primary md:text-3xl">Paling Diminati Oleh Kebanyakan Orang</h1>
				</div>
					...
					{topWisata.map((item, index) => {
						if (index === 0) {
							return (
								...
								>
									<div className="absolute top-0 right-0 z-10 px-6 py-2 bg-yellow-300 rounded-bl-3xl">
									...
									<div className="absolute z-10 text-white bottom-3 left-3">
		...
		<section>
			<div className="flex flex-col p-5 bg-primary md:px-14 xl:px-32">
				...
				<div className="flex flex-col">
					...
					<h2 className="mb-8 font-extrabold text-white text-md md:text-2xl xl:text-3xl">Pilih Penginapan Unggulan Untuk Kenyamanan Anda</h2>
				</div>

				{/* Content */}
				<div className="flex flex-wrap justify-center gap-5 xl:justify-between xl:gap-10">
		...
		<section>
			<div className="flex flex-col p-5 md:px-14 xl:px-32">
				...
				<div className="flex flex-col">
					...
					<h2 className="mb-4 font-extrabold text-md text-primary md:text-2xl xl:text-3xl">Buatlah Memori Bersama Kami Sekarang</h2>
				</div>

				{/* Content */}
				<div className="flex flex-row flex-wrap justify-center gap-2 md:flex-nowrap">
					<div className="w-full h-96 rounded-xl overflow-hidden relative md:h-72 lg:h-96 xl:h-[530px]">
						<div className="absolute w-full h-full bg-gray-900 opacity-40"></div>
	...
	return (
		<section>
			<div className="relative">
				<div className="relative w-full h-full overflow-hidden xl:h-screen">
					<div className="absolute w-full h-full bg-gray-900 opacity-40"></div>
					<img src={IMAGES.hero} alt="Virtual Tour" className="object-cover w-full h-96 xl:h-screen" />
				</div>

				<div className="absolute bottom-0 left-0 flex flex-col justify-center w-full h-full p-5 text-white md:px-14 xl:px-32">
					<p className="text-lg font-bold uppercase md:text-2xl xl:text-4xl">Menjelajahi Beragam Objek Wisata Di Cikaso</p>
					<p className="mt-2 mb-4 text-sm xl:text-lg">
						Cikaso merupakan sebuah objek wisata di Kabupaten Ciletuh yang kaya akan berbagai geosite menakjubkan.
					</p>
					<button className="flex justify-center w-40 px-5 py-3 bg-yellow-200 rounded-md">
