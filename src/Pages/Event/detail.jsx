	...
	return (
		<PortalTemplate items={items}>
			<div className="py-10 px-20 bg-green-100">
				...
				<h1 className="mb-8 text-5xl font-extrabold text-green-800">Geopark Ciletuh Spektakuler (GCS)</h1>
				<div className="grid grid-cols-3 ">
					<div className='relative overflow-hidden rounded-2xl'>
					  <img src={BgEvent1} alt="Gambar" className="h-[28rem] w-[21rem] bg-center filter brightness-75 bg-cover rounded-2xl" />
					  <div className="absolute flex flex-col items-start justify-end w-full h-full bottom-10 left-4">
							...
							<div>
								<button 
									className="px-3 py-1 font-bold text-xs text-black bg-yellow-200 hover:bg-yellow-300 rounded-lg">
									Pesan Tiket
								</button>
							</div>
						</div>
  					...
  					<div className="col-span-2 border-4 border-white rounded-lg bg-white">
						<div class="m-3 text-xl font-bold flex justify-center">
							Detail
						</div>
						<div className='text-dark text-base mx-4 my-2'>
							<p>
								GCS dilaksanakan untuk mendongkrak sektor pariwisata disini. Untuk meningkatkan perekonomian 
								dan mengembangkan Geopark Ciletuh di mata dunia. Acaranya antara lain Ciletuh Berzikir, 
								Lomba Tradisional, Festival Band, Pertunjukan Bebeguan, dan Festival Lampion Hias.
							</p>
