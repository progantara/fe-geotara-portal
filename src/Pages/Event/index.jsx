	...
	return (
		<PortalTemplate items = {items}>
			<div className="py-10 px-20 bg-green-100">
				...
				<div className="grid grid-cols-3 gap-7">
					<div className="relative col-span-2 overflow-hidden rounded-1xl">
						...
						<div className="absolute flex flex-col items-start justify-end w-full h-full bottom-10 left-4">
							...
							<a 
								href ="event/detail"
								className="text-xl font-bold text-white cursor-pointer mt-1"
							>
							...
							<div>
								<button 
									className="px-3 py-1 font-bold text-sm text-black bg-yellow-200 hover:bg-yellow-300 rounded-lg">
									<Link to ="/event/detail">Pesan Tiket</Link>
								</button>
							</div>
						</div>
					</div>
					<div className="relative overflow-hidden rounded-1xl h-[30rem]">
						...
						<div className="absolute flex flex-col items-start justify-end w-full h-full bottom-10 left-4">
							...
							<div>
								<button className="px-3 py-1 font-bold text-sm text-black bg-yellow-200 rounded-lg">
									Pesan Tiket
								</button>
							</div>
						</div>
				...
				<div className="mb-10 grid grid-cols-3 gap-7 h-[30rem] pt-5">
				...
				<h2 className="my-2 text-1xl font-bold text-primary">ACARA MENDATANG, BERLANGSUNG, SELESAI</h2>
