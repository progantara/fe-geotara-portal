...
const Home = () => {
  return (
    <>
      ...
      {/* SIDEBAR  */}
      <div class="flex flex-col border-xl sidebar lg:left-0 p-2 w-[300px] h-screen overflow-y-auto text-center bg-green-300 ">
        <div class="text-gray-100 text-xl">
          ...
          <div className="flex ml-4 mt-5">
            <form>
              ...
              <div className="flex flex-row text-black mt-3 bg-yellow-200 h-[2rem]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <div className="text-black text-lg font-medium ml-3">
                  <p>Ciemas</p>
                </div>
              </div>
              <div className="flex flex-row text-black mt-6">
