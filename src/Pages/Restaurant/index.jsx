			...
			<section className="z-50 px-20 -mt-10">
				<div className="flex flex-col px-10 py-10 bg-green-100 rounded-lg rounded-t-[3rem] text-primary">
					<div className="flex flex-col px-[16.25rem] text-center space-y-4 my-20">
						<h1 className="text-5xl font-black uppercase">TEMUKAN cafe atau resto terdekat </h1>
						<p className="text-xl">Temukan cafe atau resto untuk makan selama liburan mu !</p>
					</div>
					<div className="flex flex-col">
						<p className="text-xl font-bold text-secondary">List Restaurant</p>
						<p className="text-3xl font-bold">Avalaible Restaurant</p>
						...
						<div className="grid grid-cols-3 gap-14 ">
							{data.map((data, index) => {
								return <Card key={index} image={BgHero} link={'/restaurant/detail'} />;
							})}
						</div>
