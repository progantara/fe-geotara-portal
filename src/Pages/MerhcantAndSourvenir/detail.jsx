...
const MerhcantAndSouvenirDetail = () => {
	const items = [
		{ label: 'Merhcant & Souvenir', url: '/MerhcantAndSouvenir' },
			...
			<div className="flex flex-col p-20 bg-green-100">
				<section>
					<div className="flex flex-col text-primary">
						<p className="text-4xl font-bold">Gantungan Kunci</p>
					...
					<div className="flex my-10">
						<div class="grid grid-cols-3 gap-4 w-1/2">
							<div
								class="col-span-3 rounded-xl relative h-[35rem] w-full bg-center bg-cover"
								style={{
						...
						<div className="flex flex-col w-1/2 pl-4 space-y-4">
							<div className="flex flex-col p-4 rounded bg-white space-y-[1.375rem]">
								<p className="text-2xl font-bold text-primary">Gantungan Kunci</p>
								<div className="pr-20">
								...
								<div className="flex flex-col font-extrabold flex-coltext-2xl">
									<p>Rp</p>
									<p className="text-red-500 "> 1,097,561</p>
								</div>
							</div>
