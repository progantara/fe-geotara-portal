...
//image
import footer1 from "../../Assets/img/footer-1.jpg";
import footer2 from "../../Assets/img/footer-2.jpg";
        ...
        <div className="md:flex md:justify-between">
          <div className="flex flex-col justify-between">
            ...
            <div>
              ...
              <p>
                Alamat : Jalan Gegerkalong Hilir , Kec. Sukasari, Kota Bandung,
                Jawa Barat
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <img
                src={footer1}
                className="w-40 h-40 bg-center bg-cover border-4 border-white rounded-xl"
                alt="FlowBite Logo"
              />
              <img
                src={footer2}
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-left ">
            <p className="font-bold">
              Copyright © 2023 Geopark Kab. Sukabumi | All Rights Reserved
            </p>
