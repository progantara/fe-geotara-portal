			...
			<section className="z-50 px-20 -mt-10">
				<div className="flex flex-col px-10 py-10 bg-green-100 rounded-lg rounded-t-[3rem] text-primary">
					<div className="flex flex-col px-[16.25rem] text-center space-y-4 my-20">
						<h1 className="text-5xl font-black uppercase">TEMUKAN atraksi untuk liburan</h1>
						<p className="text-xl">Temukan atraksi selama liburan mu !</p>
					</div>
					<div className="flex flex-col">
						<p className="text-xl font-bold text-secondary">List Attraction</p>
						<p className="text-3xl font-bold">Avalaible Attraction</p>
